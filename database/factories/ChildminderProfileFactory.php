...
class ChildminderProfileFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'hourly_rate' => fake()->randomFloat(1, 5, 20), // Random hourly rate between 5 and 20 with 2 decimal places
            'service_scope_description' => fake()->optional()->sentence(10), // Random service scope description
